// TiptapEditor.tsx — rich text редактор с полной панелью форматирования
...
import { Bold, Italic, Underline as UIcon, Undo, Redo, Link as LinkIcon, List, ListOrdered, Heading, AlignLeft, AlignCenter, AlignRight } from 'lucide-react';
  ...
  return (
    <div className="border rounded bg-white p-2 space-y-2">
      <div className="flex items-center gap-2 flex-wrap text-sm">
        ...
        <button onClick={() => editor.chain().focus().toggleUnderline().run()} className={editor.isActive('underline') ? 'text-accent' : 'text-gray-500 hover:text-black'}><UIcon className="w-4 h-4" /></button>
